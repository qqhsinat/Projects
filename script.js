...
function showQuote(){
    ...
    paraElement.textContent = RandomQuote.quote;
    anotherElement.textContent = "- "+RandomQuote.author;

    clearAll();

    document.querySelector('.quote-content').appendChild(paraElement);
    document.querySelector('.quote-content').appendChild(anotherElement);
...
function showRiddle(){
  ...
  const queElem = document.createElement('p');
  queElem.textContent = question;
  const ansElem = document.createElement('p');
  ansElem.textContent = 'The answer is: ' + answer;
  ansElem.setAttribute('id','riddleanswer');
  ansElem.hidden = true;
